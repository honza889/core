...
public class NewMailServerWizard {
    ...
    private final JsmPoliciesSession selectedSession;

    public NewMailServerWizard(final JsmPoliciesPresenter presenter, final JsmPoliciesSession selectedSession) {
    ...
    Widget asWidget() {
        ...
        final Form<MailServer2Definition> form = new Form<MailServer2Definition>(MailServer2Definition.class);
        ...
        DialogueOptions options = new DialogueOptions(
                ...
                new ClickHandler() {
                    ...
                    public void onClick(ClickEvent event) {
                        ...
                        MailServer2Definition entity = form.getUpdatedEntity();
